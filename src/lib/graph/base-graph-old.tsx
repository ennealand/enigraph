...
import { Alphabet } from '../components/scg/alphabet/alphabet'
...
export const useBaseGraph = ({ width, height }: { width: number; height: number }): BaseGraphContext => {
